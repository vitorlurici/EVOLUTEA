...
const SLIDES = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1596464716127-f2a82984de30?auto=format&fit=crop&w=1920&q=80",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1588072432836-e10032774350?auto=format&fit=crop&w=1920&q=80",
          ...
          {SLIDES.map((_, index) => (
            <button
              ...
              className={`h-3 rounded-full transition-all duration-300 ${
                index === currentSlide ? "w-8 bg-accent" : "w-3 bg-white/50 hover:bg-white/80"
              }`}
